...
'''
You are given a crossword as a sequence of strings, where "X" is a shaded cell and "." is an empty cell. 
You are also given the predefined list of words in lowercase. 
(You can find it here or in the default code). 
This list is the same for all crosswords and contains about 1500 nouns. You should use only the given words.
'''
...
def convert_list_into_dict(list_of_words):
    '''
    Convert the list of words into a dictionary having key = length of word and value = list of words of that length
    '''
...
def solver(crossword, WORDS):
    ...
    words_dict = convert_list_into_dict(WORDS)
    #print(words_dict)
    
    grid = np.array(crossword)
    print(grid) 
    # 
    # ['.XXX.' 
    #  '...X.' 
